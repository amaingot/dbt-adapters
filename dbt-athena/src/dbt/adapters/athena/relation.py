...
def get_table_type(table: TableTypeDef) -> TableType:
    ...
    # Check Parameters.table_type=iceberg before TableType so that S3 Tables (which
    # report TableType="customer", not in RELATION_TYPE_MAP) are correctly classified
    # as Iceberg via the table parameter.
